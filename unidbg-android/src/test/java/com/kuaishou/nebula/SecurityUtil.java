...
public class SecurityUtil extends AbstractJni implements IOResolver<AndroidFileIO> {
    ...
    public DvmObject<?> callObjectMethod(BaseVM vm, DvmObject<?> dvmObject, String signature, VarArg varArg) {
        switch (signature) {
            case "java/io/File->getPath()Ljava/lang/String;":{
                ...
                if("android/content/Context->getFilesDir()Ljava/io/File;".equals(dvmObject.getValue())){
